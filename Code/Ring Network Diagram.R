...
edges = read_csv("Path/2DLC-Dual MS Method—code_WYT/code-2026/Example/edges.csv")
nodes = read_csv("Path/2DLC-Dual MS Method—code_WYT/code-2026/Example/nodes.csv")
